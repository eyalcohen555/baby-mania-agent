TASK_ID: conductor-shoes-rollout-001-STAGE-3-20260330-075725
APPROVAL_TIER: T3
...
כלל עצירה:
  - אם push נכשל → עצור מיד, דווח STAGE_VERDICT: FAIL + PID שנכשל
  - אם verify מדווח required_keys=0 → עצור מיד, STAGE_VERDICT: FAIL (verify contract broken)
  - אם verify נכשל → עצור מיד, STAGE_VERDICT: FAIL

אם כל 3 עברו → STAGE_VERDICT: PASS
...
EXPECTED:
3 PIDs עם push PASS + verify PASS + required_keys=3 + LIVE=YES + STAGE_VERDICT: PASS
