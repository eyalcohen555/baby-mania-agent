...
| BLOCKED | 0 | 0 | +0 |
| avg quality score | 77.7 | 80.7 | +3.0 |
...
|---|---|---|---|---|---|---|---|
| 1 | 9874906349881 | אוברול ג'ינס מתוק מבית בייבי מ | `type-romper` | `` | 96.5 | clothing_yaml | title, handle, existing_tag |

### Why safe — per candidate

**1. אוברול ג'ינס מתוק מבית בייבי מניה דגם זוהר**
- type: clothing/shoes=True | age tag: exempt | score: 96.5
- source trace: category_default, title, handle, existing_tag
- remaining risk: none visible

**Rejected candidates** (PASS אך score < 80 או בעיה אחרת):

- אוברול אריה מתוק דגם שמר — score=79.7
