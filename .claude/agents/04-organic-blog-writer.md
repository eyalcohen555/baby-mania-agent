...
### הנחיות מותג למאמרי בלוג:
- כל מאמר צריך לפנות לפרסונה ספציפית:
  - מאמרי "איך בוחרים..." → שירה (אמא שמשווה)
  - מאמרי "מתנות ל..." → רותי (סבתא שמחפשת מתנה)
  - מאמרי הורות כלליים → שתיהן
- השתמש בביטויי מותג לפחות 2 פעמים במאמר
- הימנע מהblacklist: מושלם, הכי טוב, פרימיום, יוקרתי, תינוקכם
- כשמזכירים מוצר: תאר אותו בשפת המותג — "עיצוב ייחודי", לא "מוצר איכותי"
- CTA בסוף: לשירה → "לצפייה בסטים" | לרותי → "לצפייה בסטים למתנה"
