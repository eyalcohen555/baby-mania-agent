"""
Phase 7C Live Batch 7 — Post-run verify.
...
def main():
    ...
    parser.add_argument("--exclude-title", default="", help="Informational — matches live script flag")
    ...
    log("=" * 62)
    log("Phase 7C Live Batch 7 — Post-run Verify (READ-ONLY)")
    log("=" * 62)
    ...
    if live_verify["verdict"] != "PHASE7C_LIVE_BATCH7_PASS":
