"""
Phase 7C Live Batch 4 — Post-run verify.
...
def main():
    ...
    log("=" * 62)
    log("Phase 7C Live Batch 4 — Post-run Verify (READ-ONLY)")
    log("=" * 62)
    ...
    if live_verify["verdict"] != "PHASE7C_LIVE_BATCH4_PASS":
