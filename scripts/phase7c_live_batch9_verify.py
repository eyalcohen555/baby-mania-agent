...
env.update(load_env(ENV_PATH_DESKTOP))
...
def main():
    ...
    log("=" * 62)
    log("Phase 7C Live Batch 9 — Post-run Verify (READ-ONLY)")
    log("=" * 62)
    ...
    if live_verify["verdict"] != "PHASE7C_LIVE_BATCH9_PASS":
